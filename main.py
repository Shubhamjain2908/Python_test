...
print(bcolors.BOLD + "Valos :          " +
      " 10/460 |" + bcolors.OKGREEN + "██████               " + bcolors.ENDC + bcolors.BOLD
      + "|   " +
...
print(bcolors.FAIL + bcolors.BOLD + "AN ENEMY ATTACKS" + bcolors.ENDC + " This is normal text")
...
while running:
    ...
    if index == 0:
        ...
        if item.type == "potion":
            ...
            print(bcolors.OKGREEN + "\n" + item.name + " fully stores HP/MP" + bcolors.ENDC)
